...
pub fn table() -> Vec<ChannelSpec> {
    ...
    vec![
        ChannelSpec {
            ...
            states: vec!["open", "closing"],
            transitions: vec![("open", "closing")],
            errors: vec!["UnknownKind", "ProfileMismatch"],
        },
        ChannelSpec {
            id: 0x0001,
            name: "Memory",
            kinds: vec![
                k(0, "MemoryOffer", iw, false),
                k(1, "MemoryAccept", iw, false),
                k(2, "MemoryWrite", niw, false),
                k(3, "MemoryRead", ro, false),
                k(4, "MemoryExpire", de, false),
                k(5, "MemoryRevoke", de, false),
            ],
            states: vec!["offered", "accepted", "live", "expired", "revoked"],
            transitions: vec![
                ("offered", "accepted"),
                ("accepted", "live"),
                ("live", "expired"),
            ...
            errors: vec!["AccessDenied", "MemoryError"],
        },
        ChannelSpec {
            id: 0x0002,
            name: "Capability",
            kinds: vec![
                k(0, "CapIssue", niw, false),
                k(1, "CapDelegate", niw, false),
                k(2, "CapRevoke", de, false),
                k(3, "CapLookup", ro, false),
            ],
            states: vec!["issued", "delegated", "revoked", "expired"],
            transitions: vec![
                ("issued", "delegated"),
                ("delegated", "delegated"),
                ("issued", "revoked"),
            ...
            errors: vec!["CapExceedsParent", "CapRevoked"],
        },
        ChannelSpec {
            id: 0x0003,
            name: "Identity",
            kinds: vec![
                k(0, "Rotation", niw, false),
                k(1, "Revocation", de, false),
                k(2, "ForeignLink", iw, false),
                k(3, "KeyAnnounce", ro, false),
            ],
            states: vec!["active", "rotated", "revoked"],
            transitions: vec![
                ("active", "rotated"),
                ("rotated", "rotated"),
                ("active", "revoked"),
            ...
            errors: vec!["RotationUnauthorized", "KeyRevoked", "SignerMismatch"],
        },
        ChannelSpec {
            id: 0x0004,
            name: "Governance",
            kinds: vec![
                k(0, "PolicyPublish", niw, false),
                k(1, "Approval", niw, false),
                k(2, "ApprovalHeld", ro, false),
                k(3, "Consume", niw, false),
                k(4, "GatewayDecision", niw, false),
                k(5, "DecisionRecord", niw, false),
                k(6, "EgressAttestation", niw, false),
                k(7, "HazardAuthorization", niw, false),
            ],
            states: vec!["requested", "held", "approved", "consumed", "expired"],
            transitions: vec![
                ("requested", "held"),
                ("requested", "approved"),
                ("approved", "consumed"),
        ...
        ChannelSpec {
            ...
            name: "Immune",
            kinds: vec![
                k(0, "AnomalyReport", ro, false),
                k(1, "Quarantine", de, false),
                k(2, "QuarantineLift", niw, false),
            ],
            states: vec!["normal", "quarantined", "lifted", "permanent"],
            transitions: vec![
                ("normal", "quarantined"),
                ("quarantined", "lifted"),
                ("quarantined", "permanent"),
            ],
            errors: vec!["AccessDenied"],
        },
        ChannelSpec {
            id: 0x0006,
            name: "Federation",
            kinds: vec![
                k(0, "AuthorityAnnounce", ro, false),
                k(1, "ScopeReceipt", niw, false),
            ],
            states: vec!["announced", "ordering"],
            transitions: vec![("announced", "ordering")],
            errors: vec!["AuthorityUnknown", "ScopeOverlapConflict"],
        },
        ChannelSpec {
            id: 0x0007,
            name: "Settlement",
            kinds: vec![
                k(0, "SettleIntent", niw, false),
                k(1, "SettleReceipt", niw, false),
                k(2, "SettleReject", iw, false),
                k(3, "PaymentImport", niw, false),
                k(4, "PaymentChargeBinding", niw, false),
            ],
            states: vec!["intent", "receipt", "reject"],
            transitions: vec![("intent", "receipt"), ("intent", "reject")],
            errors: vec!["ValueMismatch", "SettleExpired"],
        },
        ChannelSpec {
            id: 0x0008,
            name: "Compliance",
            kinds: vec![
                k(0, "ComplianceRecord", niw, false),
                k(1, "ComplianceQuery", ro, false),
                k(2, "ComplianceReport", ro, false),
            ],
            states: vec!["appended"],
            transitions: vec![],
            errors: vec!["RecordUnsigned", "JurisdictionUnknown"],
        },
        ChannelSpec {
            id: 0x0009,
            name: "Sensory",
            kinds: vec![
                k(0, "Observation", ro, false),
                k(1, "Subscribe", iw, false),
                k(2, "Unsubscribe", iw, false),
            ],
            states: vec!["active", "cancelled"],
            transitions: vec![("active", "cancelled")],
            errors: vec!["SubscriptionUnknown"],
        },
        ChannelSpec {
            id: 0x000A,
            name: "Telemetry",
            kinds: vec![k(0, "Metric", ro, false), k(1, "HealthReport", ro, false)],
            states: vec!["stateless"],
            transitions: vec![],
            errors: vec!["MetricMalformed"],
        },
        ChannelSpec {
            id: 0x000B,
            name: "Audit",
            kinds: vec![
                k(0, "Receipt", niw, false),
                k(1, "AuditQuery", ro, false),
                k(2, "ForkProof", ro, false),
                k(3, "CheckpointRoot", niw, false),
                k(4, "WitnessCosign", niw, false),
                k(5, "InclusionProof", ro, false),
            ],
            states: vec!["appended"],
            transitions: vec![],
            errors: vec!["ChainBroken", "Equivocation", "ReceiptUnsigned"],
        },
        ChannelSpec {
            id: 0x000C,
            name: "Stream",
            kinds: vec![
                k(0, "StreamOpen", ro, true),
                k(1, "StreamCommit", ro, false),
                k(2, "StreamCheckpoint", ro, false),
            ],
            states: vec!["open", "committed"],
            transitions: vec![("open", "committed")],
            errors: vec!["StreamDigestMismatch", "FlowControlError"],
        },
        ChannelSpec {
            id: 0x000D,
            name: "Bridge",
        ...
        ChannelSpec {
            ...
            kinds: vec![
                k(0, "Offer", ro, false),
                k(1, "Order", niw, false),
                k(2, "Fulfil", niw, false),
                k(3, "Cancel", de, false),
            ],
            states: vec!["offer", "order", "fulfil", "cancel"],
            transitions: vec![("offer", "order"), ("order", "fulfil"), ("order", "cancel")],
            errors: vec!["OfferExpired", "ApprovalRequired", "OrderMismatch"],
        },
        ChannelSpec {
            id: 0x000F,
            name: "Interaction",
            kinds: vec![
                k(0, "Elicit", ro, false),
                k(1, "Respond", iw, false),
                k(2, "Confirm", niw, false),
                k(3, "UiEvent", niw, false),
            ],
            states: vec!["elicit", "respond", "confirm", "timeout"],
            transitions: vec![
                ("elicit", "respond"),
                ("elicit", "confirm"),
                ("elicit", "timeout"),
            ],
            errors: vec!["InteractionTimeout", "ElicitUnauthorized"],
        },
        ChannelSpec {
            id: 0x0010,
            name: "Discovery",
            kinds: vec![
                k(0, "DiscoveryRecord", ro, false),
                k(1, "DiscoveryQuery", ro, false),
            ],
            states: vec!["fresh", "stale"],
            transitions: vec![("fresh", "stale")],
            errors: vec!["RecordExpired", "TrustAnchorUnknown"],
        },
        ChannelSpec {
            id: 0x0011,
            name: "Workflow",
            kinds: vec![
                k(0, "TaskCreate", niw, false),
                k(1, "TaskInput", niw, false),
                k(2, "TaskCancel", de, false),
                k(3, "TaskResult", niw, false),
            ],
            states: vec![
                "created",
                "awaiting-input",
        ...
        ChannelSpec {
            ...
            name: "Knowledge",
            kinds: vec![
                k(0, "Assert", niw, false),
                k(1, "Retract", de, false),
                k(2, "KnowledgeQuery", ro, false),
            ],
            states: vec!["asserted", "retracted"],
            transitions: vec![("asserted", "retracted")],
            errors: vec!["FactUnsigned", "RetractUnknown"],
        },
        ChannelSpec {
            id: 0x0013,
            name: "Spatial",
            kinds: vec![
                k(0, "FrameDefine", iw, false),
                k(1, "Pose", ro, false),
                k(2, "StateUpdate", ro, false),
                k(3, "SnapshotQuery", ro, false),
            ],
            states: vec!["defined", "observed"],
            transitions: vec![("defined", "observed")],
            errors: vec!["FrameUnknown", "TransformCycle"],
        },
    ]
}
...
pub fn err_effect_declaration_mismatch() -> cose::Error {
    cose::Error {
        ...
        msg: "object effect does not match the kind's declared effect",
    }
}
pub fn err_unknown_kind() -> cose::Error {
    cose::Error {
        kind: "UnknownKind",
        msg: "kind/channel not in the baseline registry",
    }
}
pub fn err_cap_exceeds_parent() -> cose::Error {
    cose::Error {
        kind: "CapExceedsParent",
        msg: "a delegation may not grant more than its parent",
    }
}
pub fn err_transform_cycle() -> cose::Error {
    cose::Error {
        kind: "TransformCycle",
        msg: "coordinate frame tree contains a cycle",
    }
}
pub fn err_input_gate_bypass() -> cose::Error {
    cose::Error {
        kind: "InputGateBypass",
        msg: "a task reached running without passing the input/approval gate",
    }
}
pub fn err_task_state() -> cose::Error {
    cose::Error {
        kind: "TaskStateError",
        msg: "workflow task state transition not permitted",
    }
}

/// The channel spec for a channel id — mirrors Go channels.Channel(id).
pub fn channel(id: u64) -> Option<ChannelSpec> {
    table().into_iter().find(|c| c.id == id)
}
...
pub fn lookup(channel: u64, kind: u64) -> Option<KindSpec> {
    table()
        .into_iter()
        .find(|c| c.id == channel)
        .and_then(|c| c.kinds.into_iter().find(|k| k.code == kind))
}
...
pub fn open_workflow_gate(path: &std::path::Path) -> Result<WorkflowGate, GateError> {
    ...
    loop {
        ...
        let nul = rec.iter().position(|&b| b == 0).ok_or_else(|| {
            GateError::Cose(cose::Error {
                kind: "Malformed",
                msg: "workflow gate record",
            })
        })?;
...
impl WorkflowGate {
    ...
    pub fn run(&mut self, task: &str) -> Result<(), GateError> {
        match self.status.get(task).map(String::as_str) {
            ...
            Some("awaiting-input") | Some("awaiting-approval") => {
                Err(GateError::Cose(err_input_gate_bypass()))
            }
            _ => Err(GateError::Cose(err_task_state())),
        }
    }
    ...
    /// Flush and close the WAL — mirrors Go WorkflowGate.Close(). Every persist() already fsyncs
    /// before acknowledging (persist-before-ack, spine §9.2), so the WAL is durable already; this
    /// performs one final fsync for good measure, consumes `self`, and drops the underlying File
    /// (Rust has no separate close() syscall wrapper — Drop closes the file descriptor), surfacing
    /// any I/O error exactly as Go's Close() surfaces os.File.Close()'s error.
    pub fn close(self) -> Result<(), GateError> {
        self.f.sync_all().map_err(GateError::Io)
    }
}
...
mod tests {
    ...
    fn surface_over_spine() {
        ...
        for ch in table() {
            ...
            // not a single-Sign1; exercise this single-Sign1 round-trip with a non-rotation
            // Identity kind (KeyAnnounce). Rotation is covered by the envelope rotation tests.
            let kind = if ch.id == 0x0003 && ch.kinds[0].code == 0 {
                ch.kinds[ch.kinds.len() - 1]
            } else {
                ch.kinds[0]
            };
            ...
            check_effect(ch.id, kind.code, eff)
                .unwrap_or_else(|_| panic!("{} declared effect rejected", ch.name));
            if !kind.variable {
                let wrong = (eff + 1) % 4;
                assert!(
                    check_effect(ch.id, kind.code, wrong).is_err(),
                    "{} wrong effect accepted",
                    ch.name
                );
            }
        }
    ...
    fn cap_exceeds_parent() {
        check_delegation(policy::NON_IDEMPOTENT_WRITE, policy::READ_ONLY)
            .expect("valid attenuation");
        assert_eq!(
            check_delegation(policy::NON_IDEMPOTENT_WRITE, policy::DESTRUCTIVE)
                .unwrap_err()
                .kind,
            "CapExceedsParent"
        );
    ...
    fn transform_cycle() {
        ...
        assert_eq!(
            check_frame_tree(&cyclic).unwrap_err().kind,
            "TransformCycle"
        );
    }
    ...
    fn workflow_input_gate_bypass() {
        ...
        assert_eq!(
            g.run("t1").unwrap_err().cose_kind(),
            Some("InputGateBypass")
        );
        // Simulate a crash right after create: close() flushes and closes the WAL (mirrors Go's
        // explicit g.Close() in the same test), then reopening recovers the pre-gate status.
        g.close().unwrap();
        let mut g2 = open_workflow_gate(&path).unwrap();
        assert_eq!(
            g2.status("t1").as_deref(),
            Some("awaiting-input"),
            "crash bypassed the gate"
        );
        assert_eq!(
            g2.run("t1").unwrap_err().cose_kind(),
            Some("InputGateBypass")
        );
    ...
    // channel(id) returns the registered spec for a known channel id and None for an unregistered
    // one — mirrors Go channels.Channel(id). Mutation: if channel() always returned table()[0] (or
    // None), the id/name checks below or the None case would flip.
    #[test]
    fn channel_lookup_by_id() {
        let c = channel(0x0011).expect("Workflow channel must be registered");
        assert_eq!(c.id, 0x0011);
        assert_eq!(c.name, "Workflow");
        assert_eq!(c.kinds.len(), table()[17].kinds.len());
        assert!(channel(0x00FF).is_none(), "unregistered channel id must be None");
    }
}
