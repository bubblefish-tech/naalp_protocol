 ...
 *   java -cp "worked-kat.jar;<bcprov.jar>" sh.bubblefish.naalp.WorkedExampleKatTestKt
 */
...
fun main() {
    println("WorkedExampleKatTest — reproduce the byte-level worked object (ML-DSA-65, seed 0x2a*32)")
    ...
    println("WorkedExampleKatTest: PASS")
}
