...
Initial public release: Internet-Draft **draft-bubblefish-naalp-00** and the ten reference SDKs.
...
- **IANA Considerations.** Requests registration of the media type `application/naalp+cbor`
  (RFC 6838) and establishment of five N-AALP registries under Specification Required / Expert
  Review / Experimental / Private Use policies. The CDDL in `spec/naalp-draft-00.cddl` is the
