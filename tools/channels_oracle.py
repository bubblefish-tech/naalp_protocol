...
CHANNELS = [
    ...
    (0x0004, "governance", "Governance",
     [(0, "PolicyPublish", NIW, False), (1, "Approval", NIW, False), (2, "ApprovalHeld", RO, False), (3, "Consume", NIW, False),
      (4, "GatewayDecision", NIW, False), (5, "DecisionRecord", NIW, False), (6, "EgressAttestation", NIW, False),
      (7, "HazardAuthorization", NIW, False)],
    ...
    (0x0007, "settlement", "Settlement",
     [(0, "SettleIntent", NIW, False), (1, "SettleReceipt", NIW, False), (2, "SettleReject", IW, False),
      (3, "PaymentImport", NIW, False), (4, "PaymentChargeBinding", NIW, False)],
    ...
    (0x000B, "audit", "Audit",
     [(0, "Receipt", NIW, False), (1, "AuditQuery", RO, False), (2, "ForkProof", RO, False),
      (3, "CheckpointRoot", NIW, False), (4, "WitnessCosign", NIW, False), (5, "InclusionProof", RO, False)],
     ["appended"], [],
