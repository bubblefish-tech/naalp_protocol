...
"""Repo-relative sys.path setup so naalp_langgraph can import the K0 framework-neutral core
...
cryptography, encoding, registry, or ledger logic of its own; it is a thin LangGraph-specific
translation over K0 + naalp_hitl.durable, mirroring naalp_kit/_bootstrap.py's,
naalp_adk_plugin/_bootstrap.py's, and naalp_hitl/_bootstrap.py's convention.
...
# naalp_langgraph/ -> naalp-langgraph/ -> ecosystem/ -> naalp_draft-01/ (repo root)
