...
"""Repo-relative sys.path setup so naalp_llamaindex can import the K0 framework-neutral core
...
cryptography, encoding, registry, or ledger logic of its own; it is a thin LlamaIndex-specific
translation over K0 + naalp_hitl.durable, mirroring naalp_kit/_bootstrap.py's,
naalp_adk_plugin/_bootstrap.py's, naalp_langgraph/_bootstrap.py's, and naalp_hitl/_bootstrap.py's
convention.
...
# naalp_llamaindex/ -> naalp-llamaindex/ -> ecosystem/ -> naalp_draft-01/ (repo root)
