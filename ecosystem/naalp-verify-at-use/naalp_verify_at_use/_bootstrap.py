...
"""Repo-relative sys.path setup so naalp_verify_at_use can import and REUSE the Part-1
Python SDK (impl/python's `naalp` package) instead of re-implementing any cryptography,
identity, or ledger logic (design.md "Buy-before-make": the verify-at-use guard is
N-AALP-specific glue, not a second copy of the approval/identity primitives).
...
# naalp_verify_at_use/ -> naalp-verify-at-use/ -> ecosystem/ -> naalp_draft-01/ -> impl/python
