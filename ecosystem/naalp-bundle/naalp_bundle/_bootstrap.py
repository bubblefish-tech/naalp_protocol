...
"""Repo-relative sys.path setup so naalp_bundle can import and REUSE the Part-1 Python SDK
(impl/python's `naalp` package) instead of re-implementing any cryptography, CBOR encoding, or
ledger logic (design.md "Buy-before-make": the offline proof bundle is N-AALP-specific glue --
packaging + independent-anchor verification -- not a second copy of the codec, COSE, or approval
primitives).
...
# naalp_bundle/ -> naalp-bundle/ -> ecosystem/ -> naalp_draft-01/ -> impl/python
