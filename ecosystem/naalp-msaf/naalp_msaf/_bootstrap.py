...
"""Repo-relative sys.path setup so naalp_msaf can import the K0 framework-neutral core
...
cryptography, encoding, registry, or ledger logic of its own; it is a thin Microsoft Agent
Framework (MSAF)-specific translation over K0 + naalp_hitl.durable, mirroring naalp_kit/
_bootstrap.py's, naalp_langgraph/_bootstrap.py's, naalp_openai_agents/_bootstrap.py's, and
naalp_adk_plugin/_bootstrap.py's convention.
...
# naalp_msaf/ -> naalp-msaf/ -> ecosystem/ -> naalp_draft-01/ (repo root)
